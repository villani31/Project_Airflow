# importando pacotes
from include.class_ import authapi, ConexaoDbSql
import pandas as pd
...
def Envia_DB_Sql(dataframe):
    try:
        dataframe.to_sql("covid19", ConexaoDbSql.conn, index=False, if_exists="append")
